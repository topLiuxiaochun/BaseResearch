...
public class MetaDataOracle {
	...
	public static void getMetadata() throws Exception{
		...
		try {
			...
			//"jdbc:oracle:thin:@localhost:1521:oracle?user=root&password=root"
			conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:oracle11g", "my_vehicle", "root");
			
			String m_TableName = "DOC_USER";
			//2. 下面就是获取表的信息。 
